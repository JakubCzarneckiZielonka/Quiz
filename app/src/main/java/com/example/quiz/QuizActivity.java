...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        option2.setText(questionsList.get(0).getOptions2());
        option3.setText(questionsList.get(0).getOptions3());
        option4.setText(questionsList.get(0).getOptions4());
    ...
    private void changeNextQuestion(){
        ...
        if (currentQuestionPosition < questionsList.size()){
            ...
            option2.setText(questionsList.get(currentQuestionPosition).getOptions2());
            option3.setText(questionsList.get(currentQuestionPosition).getOptions3());
            option4.setText(questionsList.get(currentQuestionPosition).getOptions4());
        }else {
